...
from .views import ClientsViewSet, DocsViewSet, ManagersViewSet, OrganizationsViewSet, ProjectsViewSet, StatusViewSet, TasksViewSet, UsersViewSet, WorkgroupsViewSet, WorkingDeveloperListViewSet, DevelopersViewSet
