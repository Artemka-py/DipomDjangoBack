...
const Task = (props) => {
  ...
  // Верстка с логиков полей с датой
  const DatePickers = () => {
    return (
      <>
  ...
  useEffect(() => {
    setLoading(true);
    fetchData().then(setLoading(false)).then(getTasks()).then(getDevelopers());
          ...
          <>
            {editable ? (
              <>
                <Row>
                  <Col span={16}>
                    <Input defaultValue={data.task_name} />
                  </Col>
                  <Col span={8}>
                    <Button
                      type="primary"
              ...
              <>
                ...
                <Row>
                  <Col span={6} style={{ textAlign: 'center' }}>
                    <p>
                      Постановщик:<br></br>
                      <b>{data.task_setter_login}</b>
                    </p>
                  </Col>
                  <Col span={6} style={{ textAlign: 'center' }}>
                    <p>
                      Исполнитель: <br></br>
                      <b>{data.task_developer_login}</b>
                    </p>
                  </Col>
                  <Col span={6} style={{ textAlign: 'center' }}>
                    <p>
